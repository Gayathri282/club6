...
(function() {
    "use strict";
    if (typeof OZEUM_STORAGE == 'undefined') {
        window.OZEUM_STORAGE = {};
    }
    window.ozeum_storage_get = function(var_name) {
        return ozeum_isset(OZEUM_STORAGE[var_name]) ? OZEUM_STORAGE[var_name] : '';
    };
    window.ozeum_storage_set = function(var_name, value) {
        OZEUM_STORAGE[var_name] = value;
    };
    window.ozeum_storage_inc = function(var_name) {
        var value = arguments[1] === undefined ? 1 : arguments[1];
        OZEUM_STORAGE[var_name] += value;
    };
    window.ozeum_storage_concat = function(var_name, value) {
        OZEUM_STORAGE[var_name] += '' + value;
    };
    window.ozeum_storage_get_array = function(var_name, key) {
        return ozeum_isset(OZEUM_STORAGE[var_name][key]) ? OZEUM_STORAGE[var_name][key] : '';
    };
    window.ozeum_storage_set_array = function(var_name, key, value) {
        if (!ozeum_isset(OZEUM_STORAGE[var_name])) {
            OZEUM_STORAGE[var_name] = {};
        }
        OZEUM_STORAGE[var_name][key] = value;
    };
    window.ozeum_storage_inc_array = function(var_name, key) {
        var value = arguments[2] === undefined ? 1 : arguments[2];
        OZEUM_STORAGE[var_name][key] += value;
    };
    window.ozeum_storage_concat_array = function(var_name, key, value) {
        OZEUM_STORAGE[var_name][key] += '' + value;
    };
    window.ozeum_isset = function(obj) {
        return typeof(obj) != 'undefined';
    };
    window.ozeum_empty = function(obj) {
        return typeof(obj) == 'undefined' || (typeof(obj) == 'object' && obj == null) || (typeof(obj) == 'array' && obj.length == 0) || (typeof(obj) == 'string' && ozeum_alltrim(obj) == '') || obj === 0;
    };
    window.ozeum_is_array = function(obj) {
        return typeof(obj) == 'array';
    };
    window.ozeum_is_object = function(obj) {
        return typeof(obj) == 'object';
    };
    window.ozeum_clone_object = function(obj) {
        if (obj === null || typeof(obj) != 'object') {
            return obj;
        }
        var temp = {};
        for (var key in obj) {
            temp[key] = ozeum_clone_object(obj[key]);
        }
        return temp;
    };
    window.ozeum_merge_objects = function(obj1, obj2) {
        for (var i in obj2) {
            obj1[i] = obj2[i];
        }
        return obj1;
    };
    window.ozeum_array_merge = function(a1, a2) {
        for (var i in a2) {
            a1[i] = a2[i];
        }
        return a1;
    };
    window.ozeum_array_first_key = function(arr) {
        var rez = null;
        for (var i in arr) {
            rez = i;
            break;
    ...
    window.ozeum_array_first_value = function(arr) {
        var rez = null;
        for (var i in arr) {
            rez = arr[i];
            break;
    ...
    window.ozeum_serialize = function(mixed_val) {
            ...
            case "object":
                if (mixed_val == null) {
                    ...
                    for (var i = 0; i < mixed_val.length; i++) {
                        idxobj.idx++;
                        var ser = ozeum_serialize(mixed_val[i]);
                        if (ser) {
                            map.push(ozeum_serialize(idxobj.idx) + ser);
                        }
                    }
                    return "a:" + mixed_val.length + ":{" + map.join("") + "}";
                } else {
                    var class_name = ozeum_get_class(mixed_val);
                    if (class_name == undefined) {
                        return false;
                    }
                    var props = new Array();
                    for (var prop in mixed_val) {
                        var ser = ozeum_serialize(mixed_val[prop]);
                        if (ser) {
                            props.push(ozeum_serialize(prop) + ser);
                        }
                    }
                    if (obj_to_array) {
    ...
    (function($) {
        ...
        var Plugin = $.ozeum_encoder = function(dir, input, encode) {
    ...
    window.ozeum_get_class = function(obj) {
    ...
    window.ozeum_add_filter = function(filter, callback, priority) {
        if (typeof wp != 'undefined' && typeof wp.hooks != 'undefined') {
            wp.hooks.addFilter(filter, 'ozeum', callback, priority == undefined ? 10 : priority);
        }
    };
    window.ozeum_apply_filters = function(filter, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
        if (typeof wp != 'undefined' && typeof wp.hooks != 'undefined') {
    ...
    window.ozeum_add_action = function(action, callback, priority) {
        if (typeof wp != 'undefined' && typeof wp.hooks != 'undefined') {
            wp.hooks.addAction(action, 'ozeum', callback, priority == undefined ? 10 : priority);
        }
    };
    window.ozeum_do_actions = function(action, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
        if (typeof wp != 'undefined' && typeof wp.hooks != 'undefined') {
            wp.hooks.doActions(action, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        }
    };
    window.ozeum_in_list = function(str, list) {
    ...
    window.ozeum_alltrim = function(str) {
    ...
    window.ozeum_ltrim = function(str) {
        return ozeum_alltrim(str, 'l');
    };
    window.ozeum_rtrim = function(str) {
        return ozeum_alltrim(str, 'r');
    };
    window.ozeum_padl = function(str, len) {
    ...
    window.ozeum_padr = function(str, len) {
        var ch = arguments[2] !== undefined ? arguments[2] : ' ';
        var rez = str.substr(0, len);
        if (rez.length < len) {
            for (var i = 0; i < len - str.length; i++) {
    ...
    window.ozeum_padc = function(str, len) {
        var ch = arguments[2] !== undefined ? arguments[2] : ' ';
        var rez = str.substr(0, len);
        if (rez.length < len) {
    ...
    window.ozeum_replicate = function(str, num) {
        var rez = '';
        for (var i = 0; i < num; i++) {
            rez += str;
        }
    ...
    window.ozeum_prepare_macros = function(str) {
        return str.replace(/\{\{/g, "<i>").replace(/\}\}/g, "</i>").replace(/\(\(/g, "<b>").replace(/\)\)/g, "</b>").replace(/\|\|/g, "<br>");
    };
    window.ozeum_round_number = function(num) {
        var precision = arguments[1] !== undefined ? arguments[1] : 0;
        var p = Math.pow(10, precision);
        return Math.round(num * p) / p;
    };
    window.ozeum_clear_number = function(num) {
        var precision = arguments[1] !== undefined ? arguments[1] : 0;
    ...
    window.ozeum_dec2hex = function(n) {
        return Number(n).toString(16);
    };
    window.ozeum_hex2dec = function(hex) {
        return parseInt(hex, 16);
    };
    window.ozeum_in_array = function(val, thearray) {
        var rez = false;
    ...
    window.ozeum_sort_array = function(thearray) {
    ...
    window.ozeum_parse_date = function(dt) {
    ...
    window.ozeum_get_date_difference = function(dt1) {
        var dt2 = arguments[1] !== undefined ? arguments[1] : '';
        var short_date = arguments[2] !== undefined ? arguments[2] : true;
        var sec = arguments[3] !== undefined ? arguments[3] : false;
        var a1 = ozeum_parse_date(dt1);
        dt1 = Date.UTC(a1[0], a1[1], a1[2], a1[3], a1[4], a1[5]);
        if (dt2 == '') {
            dt2 = new Date();
            var a2 = [dt2.getFullYear(), dt2.getMonth() + 1, dt2.getDate(), dt2.getHours(), dt2.getMinutes(), dt2.getSeconds()];
        } else {
            var a2 = ozeum_parse_date(dt2);
        }
    ...
    window.ozeum_hex2rgb = function(hex) {
    ...
    window.ozeum_hex2rgba = function(hex, alpha) {
        var rgb = ozeum_hex2rgb(hex);
        return 'rgba(' + rgb.r + ',' + rgb.g + ',' + rgb.b + ',' + alpha + ')';
    };
    window.ozeum_rgb2hex = function(color) {
        var aRGB;
    ...
    window.ozeum_components2hex = function(r, g, b) {
    ...
    window.ozeum_rgb2components = function(color) {
        color = ozeum_rgb2hex(color);
    ...
    window.ozeum_hex2hsb = function(hex) {
        var h = arguments[1] !== undefined ? arguments[1] : 0;
        var s = arguments[2] !== undefined ? arguments[2] : 0;
        var b = arguments[3] !== undefined ? arguments[3] : 0;
        var hsb = ozeum_rgb2hsb(ozeum_hex2rgb(hex));
        hsb.h = Math.min(359, Math.max(0, hsb.h + h));
        hsb.s = Math.min(100, Math.max(0, hsb.s + s));
        hsb.b = Math.min(100, Math.max(0, hsb.b + b));
        return hsb;
    };
    window.ozeum_hsb2hex = function(hsb) {
        var rgb = ozeum_hsb2rgb(hsb);
        return ozeum_components2hex(rgb.r, rgb.g, rgb.b);
    };
    window.ozeum_rgb2hsb = function(rgb) {
        var hsb = {};
    ...
    window.ozeum_hsb2rgb = function(hsb) {
        var rgb = {};
    ...
    window.ozeum_color_picker = function() {
        ...
        jQuery(document.createElement("div")).attr("id", id).css('display', 'none').html(tbl).appendTo("body").addClass("iColorPickerTable").on('mouseover', 'thead td', function() {
            var aaa = ozeum_rgb2hex(jQuery(this).css('background-color'));
            ...
            if (thead.hasClass('more_colors')) {
                ...
                while (rgb[0] < 0xF || rgb[1] < 0xF || rgb[2] < 0xF) {
                    ...
                    i++;
                    out += '<td style="background-color:' + ozeum_components2hex(rgb[0] * 16 + rgb[0], rgb[1] * 16 + rgb[1], rgb[2] * 16 + rgb[2]) + '">&nbsp;</td>';
                    rgb[2] += 3;
                    if (rgb[2] > 0xF) {
                        rgb[1] += 3;
                        if (rgb[1] > (j === 0 ? 6 : 0xF)) {
    ...
    window.ozeum_color_picker_show = function(id, fld, func) {
        if (id === null || id === '') {
        ...
        var def = fld.val().substr(0, 1) == '#' ? fld.val() : ozeum_rgb2hex(fld.css('backgroundColor'));
        jQuery('#' + id + '_colorPreview input,#' + id + '_colorOriginal input').val(def);
        jQuery('#' + id + '_colorPreview,#' + id + '_colorOriginal').css('background', def);
    };
    window.ozeum_get_cookie = function(name) {
    ...
    window.ozeum_set_cookie = function(name, value) {
    ...
    window.ozeum_del_cookie = function(name) {
        var path = arguments[1] !== undefined ? arguments[1] : '/';
        var domain = arguments[2] !== undefined ? arguments[2] : '';
        if (ozeum_get_cookie(name)) {
            document.cookie = name + '=' + ((path) ? ';path=' + path : '') + ((domain) ? ';domain=' + domain : '') + ';expires=Thu, 01-Jan-1970 00:00:01 GMT';
        }
    };
    window.ozeum_is_local_storage_exists = function() {
        try {
    ...
    window.ozeum_get_storage = function(name) {
        var defa = arguments[1] !== undefined ? arguments[1] : null;
        var val = null;
        if (ozeum_is_local_storage_exists()) {
            val = window['localStorage'].getItem(name);
            if (val === null) val = defa;
        } else {
            val = ozeum_get_cookie(name, defa);
        }
        return val;
    };
    window.ozeum_set_storage = function(name, value) {
        if (ozeum_is_local_storage_exists()) window['localStorage'].setItem(name, value);
        else ozeum_set_cookie(name, value, 365);
    };
    window.ozeum_del_storage = function(name) {
        if (ozeum_is_local_storage_exists()) window['localStorage'].removeItem(name);
        else ozeum_del_cookie(name);
    };
    window.ozeum_clear_storage = function() {
        if (ozeum_is_local_storage_exists()) window['localStorage'].clear();
    };
    window.ozeum_clear_listbox = function(box) {
        for (var i = box.options.length - 1; i >= 0; i--) {
            box.options[i] = null;
        }
    };
    window.ozeum_add_listbox_item = function(box, val, text) {
        var item = new Option();
        item.value = val;
        item.text = text;
        box.options.add(item);
    };
    window.ozeum_del_listbox_item_by_value = function(box, val) {
    ...
    window.ozeum_del_listbox_item_by_text = function(box, txt) {
        for (var i = 0; i < box.options.length; i++) {
    ...
    window.ozeum_find_listbox_item_by_value = function(box, val) {
        var idx = -1;
        for (var i = 0; i < box.options.length; i++) {
            if (box.options[i].value == val) {
                idx = i;
    ...
    window.ozeum_find_listbox_item_by_text = function(box, txt) {
        var idx = -1;
        for (var i = 0; i < box.options.length; i++) {
            if (box.options[i].text == txt) {
                idx = i;
    ...
    window.ozeum_select_listbox_item_by_value = function(box, val) {
        for (var i = 0; i < box.options.length; i++) {
            box.options[i].selected = (val == box.options[i].value);
        }
    };
    window.ozeum_select_listbox_item_by_text = function(box, txt) {
        for (var i = 0; i < box.options.length; i++) {
            box.options[i].selected = (txt == box.options[i].text);
        }
    };
    window.ozeum_get_listbox_values = function(box) {
    ...
    window.ozeum_get_listbox_texts = function(box) {
        var delim = arguments[1] !== undefined ? arguments[1] : ',';
        var str = '';
        for (var i = 0; i < box.options.length; i++) {
    ...
    window.ozeum_sort_listbox = function(box) {
    ...
    window.ozeum_get_listbox_selected_index = function(box) {
        for (var i = 0; i < box.options.length; i++) {
    ...
    window.ozeum_get_listbox_selected_value = function(box) {
        for (var i = 0; i < box.options.length; i++) {
            if (box.options[i].selected) {
    ...
    window.ozeum_get_listbox_selected_text = function(box) {
        for (var i = 0; i < box.options.length; i++) {
            if (box.options[i].selected) {
    ...
    window.ozeum_get_listbox_selected_option = function(box) {
        for (var i = 0; i < box.options.length; i++) {
            if (box.options[i].selected) {
    ...
    window.ozeum_get_radio_value = function(radioGroupObj) {
    ...
    window.ozeum_set_radio_checked_by_num = function(radioGroupObj, num) {
        for (var i = 0; i < radioGroupObj.length; i++) {
    ...
    window.ozeum_set_radio_checked_by_value = function(radioGroupObj, val) {
        for (var i = 0; i < radioGroupObj.length; i++) {
    ...
    window.ozeum_form_validate = function(form, opt) {
        var error_msg = '';
    ...
    window.ozeum_document_animate_to = function(id) {
        ...
        if (isNaN(id)) {
            ...
            oft = obj.offset().top;
            oft2 = Math.max(0, oft - ozeum_fixed_rows_height());
        }
        if (speed < 0) {
    ...
    window.ozeum_fixed_rows_height = function() {
        ...
        if (with_fixed_rows && !jQuery('body').hasClass('header_position_over')) {
    ...
    window.ozeum_document_set_location = function(curLoc) {
        try {
    ...
    window.ozeum_add_to_url = function(loc, prm) {
    ...
    window.ozeum_is_local_link = function(url) {
    ...
    window.ozeum_browser_is_mobile = function() {
        var check = false;
        (function(a) {
    ...
    window.ozeum_browser_is_ios = function() {
        return navigator.userAgent.match(/iPad|iPhone|iPod/i) != null;
    };
    window.ozeum_is_retina = function() {
        var mediaQuery = '(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)';
        return (window.devicePixelRatio > 1) || (window.matchMedia && window.matchMedia(mediaQuery).matches);
    };
    window.ozeum_get_file_name = function(path) {
        path = path.replace(/\\/g, '/');
    ...
    window.ozeum_get_file_ext = function(path) {
        var pos = path.lastIndexOf('.');
        path = pos >= 0 ? path.substr(pos + 1) : '';
        return path;
    };
    window.ozeum_is_images_loaded = function(cont) {
        var complete = true;
    ...
    window.ozeum_when_images_loaded = function(cont, callback, max_delay) {
        if (max_delay === undefined) {
            var max_delay = 3000;
        }
        if (max_delay <= 0 || ozeum_is_images_loaded(cont)) {
            callback();
        } else {
            setTimeout(function() {
                ozeum_when_images_loaded(cont, callback, max_delay - 200);
            }, 200);
        }
    };
    window.ozeum_debug_object = function(obj) {
        ...
        if (obj !== null && (typeof(obj) == 'object' || typeof(obj) == 'array')) {
            for (var prop in obj) {
                ...
                if (level < recursive && (typeof(obj[prop]) == 'object' || typeof(obj[prop]) == 'array') && obj[prop] != obj) {
                    dispStr += addStr + prop + '=' + ozeum_debug_object(obj[prop], recursive, showMethods, level + 1);
                } else {
                    try {
                        curStr = "" + obj[prop];
                    } catch (e) {
    ...
    window.ozeum_debug_log = function(s, clr) {
        if (OZEUM_STORAGE['user_logged_in']) {
    ...
    window.dco === undefined && (window.dco = function(s, r) {
        console.log(ozeum_debug_object(s, r));
    });
    ...
    window.ddo === undefined && (window.ddo = function(s, r, c) {
        ozeum_debug_log(ozeum_debug_object(s, r), c);
    });
})();
jQuery(document).ready(function() {
    ...
    function ozeum_init_actions() {
        ...
        if (jQuery('body').hasClass('menu_side_present')) {
            ...
            if (side_logo.length > 0 && !ozeum_is_images_loaded(side_logo)) {
                ozeum_when_images_loaded(side_logo, function() {
    ...
    function ozeum_ready_actions() {
        ...
        jQuery('a.ozeum_skip_link:not(.inited)').addClass('inited').on('focus', function() {
        ...
        jQuery('body').on('keydown', 'a,input,textarea,select', function(e) {
            if (9 == e.which) {
                if (!jQuery('body').hasClass('show_outline')) {
                    jQuery('body').addClass('show_outline');
                }
        ...
        if (jQuery('.ozeum_tabs:not(.inited)').length > 0 && jQuery.ui && jQuery.ui.tabs) {
            jQuery('.ozeum_tabs:not(.inited)').each(function() {
        ...
        jQuery('.ozeum_tabs_ajax').on("tabsbeforeactivate", function(event, ui) {
            if (ui.newPanel.data('need-content')) {
                ozeum_tabs_ajax_content_loader(ui.newPanel, 1, ui.oldPanel);
            }
        });
        jQuery('.ozeum_tabs_ajax').on("click", '.nav-links a', function(e) {
        ...
        jQuery('.nav-load-more').on('click', function(e) {
            ...
            if (panel.length === 0) {
                jQuery.get(location.href, {
                    ...
                    if (posts_container.length > 0) {
                        ozeum_loadmore_add_items(jQuery('.content .posts_container').eq(0), posts_container.find('> .masonry_item,' + '> div[class*="column-"],' + '> article'));
                    }
                });
            } else {
                jQuery.post(OZEUM_STORAGE['ajax_url'], {
                    ...
                    try {
                        ...
                        rez = {
                            error: OZEUM_STORAGE['msg_ajax_error']
                        };
                    ...
                    if (rez.error !== '') {
                        ...
                        ozeum_loadmore_add_items(panel.find('.posts_container'), jQuery(rez.data).find('> .masonry_item,' + '> div[class*="column-"],' + '> article'));
                    }
                });
            }
            ...
            function ozeum_loadmore_add_items(container, items) {
                if (container.length > 0 && items.length > 0) {
                    ...
                    if (container.hasClass('portfolio_wrap') || container.hasClass('masonry_wrap')) {
                        ...
                        ozeum_when_images_loaded(just_loaded_items, function() {
        ...
        jQuery(document).on('action.scroll_ozeum', function(e) {
            if (OZEUM_STORAGE['load_more_link_busy']) {
                return;
            }
        ...
        jQuery(document).on('action.scroll_ozeum', function(e) {
            ...
            var container = OZEUM_STORAGE['which_block_load'] == 'article' ? jQuery('.content').eq(0) : jQuery('.page_content_wrap').eq(0),
            ...
            scrollers.each(function() {
                ...
                if (inf.hasClass('nav-links-single-scroll-loaded')) {
                    ...
                    jQuery.get(ozeum_add_to_url(link, {
                        'action': 'prev_post_loading'
                    })).done(function(response) {
                        ozeum_import_inline_styles(response);
                        var post_content = jQuery(response).find(OZEUM_STORAGE['which_block_load'] == 'article' ? '.content' : '.page_content_wrap');
                        if (post_content.length > 0) {
                            ...
                            container.append('<div class="previous_post_content' + (post_content.attr('data-single-style') !== undefined ? ' single_style_' + post_content.attr('data-single-style') : '') + '">' + html + '</div>');
        ...
        jQuery('.posts_container,.sc_blogger_content.sc_item_posts_container').on('click', 'a', function(e) {
            ...
            if (link_url && post_url && link_url == post_url && (posts_container.hasClass('open_full_post') || OZEUM_STORAGE['open_full_post']) && !posts_container.hasClass('columns_wrap') && !posts_container.hasClass('masonry_wrap') && !posts_container.hasClass('chess_wrap') && posts_container.find('.sc_blogger_grid_wrap').length === 0 && posts_container.find('.masonry_wrap').length === 0 && posts_container.parents('.wp-block-columns').length === 0 && (posts_container.parents('.wpb_column').length === 0 || posts_container.parents('.wpb_column').eq(0).hasClass('vc_col-sm-12')) && (posts_container.parents('.elementor-column').length === 0 || posts_container.parents('.elementor-column').eq(0).hasClass('elementor-col-100'))) {
                ...
                jQuery.get(ozeum_add_to_url(post_url, {
    ...
    function ozeum_stretch_sidemenu() {
        ...
        var toc_items_height = jQuery(window).height() - ozeum_fixed_rows_height(true, false) - jQuery('.menu_side_wrap .sc_layouts_logo').outerHeight() - toc_items.length;
    ...
    jQuery(document).on('action.toc_menu_item_active', function() {
        ...
        var th = toc_items.eq(0).height(),
            ...
            menu_side_height = jQuery(window).height() - ozeum_fixed_rows_height(true, false) - jQuery('.menu_side_wrap .sc_layouts_logo').outerHeight() - jQuery('.menu_side_wrap .sc_layouts_logo + .toc_menu_item').outerHeight();
    ...
    function ozeum_stretch_height(e, cont) {
        ...
        cont.find('.ozeum-full-height').each(function() {
            ...
            if (fullheight_row.hasClass('vc_row-o-full-height') || fullheight_row.hasClass('elementor-section-height-full')) {
                ...
                var wh = jQuery(window).height() >= 698 && jQuery(window).width() > 1024 ? jQuery(window).height() - ozeum_fixed_rows_height() : 'auto';
                if (wh > 0) {
    ...
    function ozeum_resize_video(cont) {
        ...
        cont.find('video').each(function() {
            ...
            var video = jQuery(this).addClass('ozeum_resize').eq(0);
        ...
        cont.find('.video_frame iframe,iframe').each(function() {
            if (jQuery(this).hasClass('trx_addons_resize') || jQuery(this).hasClass('trx_addons_noresize') || jQuery(this).addClass('ozeum_resize').parents('div:hidden,section:hidden,article:hidden').length > 0) {
                return;
            }
                ...
                if (content.css('float') == 'none') {
                    ...
                    if (sb_height < content_height && scroll_offset + top_panel_fixed_height > content_top) {
                        ...
                        if (sb_init.position != 'undefined') {
                            ...
                            sb_init.left = sb_init.position == 'fixed' || jQuery('body').hasClass('body_style_fullwide') || jQuery('body').hasClass('body_style_fullscreen') ? sb.prev().offset().left : sb.prev().position().left;
                            sb_init.right = 'auto';
                            sb_init.width = sb.prev().width() + parseFloat(sb.prev().css('paddingLeft')) + parseFloat(sb.prev().css('paddingRight'));
                            if (force || sb.css('position') != sb_init.position || OZEUM_STORAGE['scroll_dir_last'] != scroll_dir || sb.width() != sb_init.width) {
    ...
    function ozeum_init_post_formats(e, cont) {
        cont.find('select:not(.esg-sorting-select):not([class*="trx_addons_attrib_"])').each(function() {
            var s = jQuery(this);
            if (s.css('display') != 'none' && s.parents('.select_container').length === 0 && !s.next().hasClass('select2') && !s.hasClass('select2-hidden-accessible')) {
        ...
        cont.find('.post_featured.with_thumb .post_video_hover:not(.post_video_hover_popup):not(.inited)').addClass('inited').on('click', function(e) {
            jQuery(this).parents('.post_featured').eq(0).addClass('post_video_play').find('.post_video').html(jQuery(this).data('video'));
            jQuery(window).trigger('resize');
            e.preventDefault();
            return false;
        });
        ...
        if (OZEUM_STORAGE['use_mediaelements'] && cont.find(media_selector).length > 0) {
            if (window.mejs) {
                ...
                cont.find(media_selector).each(function() {
                    ...
                    if ($self.addClass('inited').parents('.mejs-mediaelement').length === 0 && $self.parents('.wp-block-video').length === 0 && !$self.hasClass('wp-block-cover__video-background') && $self.parents('.elementor-background-video-container').length === 0 && (OZEUM_STORAGE['init_all_mediaelements'] || (!$self.hasClass('wp-audio-shortcode') && !$self.hasClass('wp-video-shortcode') && !$self.parent().hasClass('wp-playlist')))) {
...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
    "use strict";
    if (OZEUM_STORAGE['button_hover'] && OZEUM_STORAGE['button_hover'] != 'default') {
        jQuery('button:not(.search_submit):not(.full_post_close):not([class*="sc_button_hover_"]),\ .theme_button:not([class*="sc_button_hover_"]),\ .sc_button:not([class*="sc_button_simple"]):not([class*="sc_button_bordered"]):not([class*="sc_button_hover_"]),\ .sc_form_field button:not([class*="sc_button_hover_"]),\ .post_item .more-link:not([class*="sc_button_hover_"]),\ .trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_"]),\ .ozeum_tabs .ozeum_tabs_titles li a:not([class*="sc_button_hover_"]),\ .hover_shop_buttons .icons a:not([class*="sc_button_hover_style_"]),\ .mptt-navigation-tabs li a:not([class*="sc_button_hover_style_"]),\ .edd_download_purchase_form .button:not([class*="sc_button_hover_style_"]),\ .edd-submit.button:not([class*="sc_button_hover_style_"]),\ .widget_edd_cart_widget .edd_checkout a:not([class*="sc_button_hover_style_"]),\ .woocommerce #respond input#submit:not([class*="sc_button_hover_"]),\ .woocommerce .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]),\ .woocommerce-page .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]),\ #buddypress a.button:not([class*="sc_button_hover_"])\ ').addClass('sc_button_hover_just_init sc_button_hover_' + OZEUM_STORAGE['button_hover']);
        if (OZEUM_STORAGE['button_hover'] != 'arrow') {
        ...
        jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\ .ozeum_tabs .ozeum_tabs_titles li a:not([class*="sc_button_hover_style_"]),\ .widget_tag_cloud a:not([class*="sc_button_hover_style_"]),\ .widget_product_tag_cloud a:not([class*="sc_button_hover_style_"])\ ').addClass('sc_button_hover_just_init sc_button_hover_style_alterbd');
        ...
        jQuery('.mejs-controls button,\ .mfp-close,\ .sc_button_bg_image,\ .hover_shop_buttons a,\ button.pswp__button,\ .woocommerce-orders-table__cell-order-actions .button,\ .sc_layouts_row_type_narrow .sc_button\ ').removeClass('sc_button_hover_' + OZEUM_STORAGE['button_hover']);
    }
});
(function() {
    "use strict";
...
(function() {
    "use strict";
    jQuery(document).on('action.ready_ozeum', function() {
        jQuery('.woocommerce,.woocommerce-page').on('click', '.ozeum_shop_mode_buttons a', function(e) {
