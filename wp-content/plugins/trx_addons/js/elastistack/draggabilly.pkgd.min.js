    ...
    function(a) {
        ...
        function d(d, e, g, j, k) {
            ...
            b(m.prototype, e.prototype), m.prototype.options = {}, m.prototype._create = function() {
                ...
                this.handles = this.options.handle ? this.element.querySelectorAll(this.options.handle) : [this.element], this.bindHandles(!0)
            }, m.prototype.bindHandles = function(b) {
                var c;
                c = a.navigator.pointerEnabled ? this.bindPointer : a.navigator.msPointerEnabled ? this.bindMSPointer : this.bindMouseTouch, b = void 0 === b ? !0 : !!b;
                ...
                var c = b ? "bind" : "unbind";
                g[c](a, "pointerdown", this), a.style.touchAction = b ? "none" : ""
            }, m.prototype.bindMSPointer = function(a, b) {
                var c = b ? "bind" : "unbind";
                g[c](a, "MSPointerDown", this), a.style.msTouchAction = b ? "none" : ""
            }, m.prototype.bindMouseTouch = function(a, b) {
                var c = b ? "bind" : "unbind";
                g[c](a, "mousedown", this), g[c](a, "touchstart", this), b && t(a)
            };
            ...
            return m.prototype.setLeftTop = function() {
                ...
                this.disable(), q && (this.element.style[q] = ""), this.element.style.left = "", this.element.style.top = "", this.element.style.position = "", this.bindHandles(!1)
            }, m
        }
